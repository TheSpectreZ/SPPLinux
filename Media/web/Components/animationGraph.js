...
function InitializeMaterialGraph(width, height, buttons)
{
    ...
    window.InvokeNative("AnimGraphJSReady");
...
class AnimationNode {
    constructor() {
        this.addOutput("Value", "Animation");
...
LiteGraph.registerNodeType("Animation/Animation", AnimationNode);
class AnimationOutputNode
{
    constructor()
    {
        this.addInput("Value", "Animation");
...
LiteGraph.registerNodeType("Animation/OutputNode", AnimationOutputNode);
