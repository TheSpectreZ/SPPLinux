...
{
	float2 pixelPosition = float2( GlobalInvocationID.x / (float)ViewConstants.ViewFrame.x, GlobalInvocationID.y / (float)ViewConstants.ViewFrame.y );
